...
ZH_MAP = {
    ...
    "&About": "关于(&A)",
    "About 影图": "关于 影图",
    "<h2>影图</h2><p>Version 1.0.0</p><p>A powerful image processing tool.</p>": "<h2>影图</h2><p>版本 1.0.0</p><p>一款强大的图片处理工具。</p>",
    "Zoom Out": "缩小",
    "Original Size": "原始尺寸",
    "Zoom In": "放大",
    "Fit": "适应",
    ...
    "Uniform Width": "统一宽度",
    "Uniform Height": "统一高度",
    "Crop Input Margins": "裁剪输入白边",
    "Crop Output Margins": "裁剪输出白边",
    "Image widths are inconsistent": "图片宽度不一致",
    "Image heights are inconsistent": "图片高度不一致",
    "%1 of %2 grid cells will be empty": "%2 个网格中 %1 个将为空",
    "%1 extra image(s) will be ignored": "%1 张多余图片将被忽略",
    "Stitch Settings": "拼接设置",
    "Grid Presets": "网格预设",
    "Output Settings": "输出设置",
    "Batch Select": "批量选择",
    "Batch select images for stitching": "批量选择图片参与拼接",
    "Select All": "全选",
    ...
    "Spacing is out of range": "间距超出范围",
    ...
    "Successfully exported %1 images to PDF": "成功导出 %1 张图片为 PDF",
    "No images to export.": "没有可导出的图片。",
    # ── 图片信息 ──
    "Image Info": "图片信息",
    "File: %1\nSize: %2x%3": "文件：%1\n尺寸：%2x%3",
}
